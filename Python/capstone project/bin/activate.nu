...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/heba/Sprints-DevOps/Python/capstone project'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/heba/Sprints-DevOps/Python/capstone project/bin/deactivate.nu'
